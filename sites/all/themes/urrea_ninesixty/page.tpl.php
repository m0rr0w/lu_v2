...
<div id="page" class="container-12 clearfix">
  <div id="site-header<?php if ($is_front): print('-front'); endif; ?>" class="grid-12 clearfix">  
    <div id="branding" class="grid-12 clearfix">
      <?php if ($linked_logo_img): ?>
        <span id="logo" class="grid-7 alpha"><?php print $linked_logo_img; ?></span>
      <?php endif; ?>
      <?php if ($linked_site_name): ?>
        <h1 id="site-name" class="grid-6 omega clearfix"><?php print $linked_site_name; ?></h1>
      <?php endif; ?>
      <?php if ($site_slogan): ?>
        <div id="site-slogan" class="grid-7 omega"><?php print $site_slogan; ?></div>
      <?php endif; ?>
    </div>
    <?php if ($page['header']): ?>
      <div id="header-region" class="grid-12 clearfix">
...
<?php endif; ?>
  <div id="inferiores" class="grid-12 clearfix">
    ...
    <?php if ($page['secundum_inferiores']): ?>
      <div id="secundum-inferiores" class="region <?php print ns('grid-3', $page['sidebar_second']); ?>">
        <?php print render($page['secundum_inferiores']);?>
      </div>
    <?php endif; ?>
    <?php if ($page['tertia_inferiores']): ?>
      <div id="tertia-inferiores" class="region <?php print ns('grid-3', $page['tryptic_first']); ?> ">
        <?php print render($page['tertia_inferiores']);?>
      </div>
    <?php endif; ?>
    <?php if ($page['cuatro_inferiores']): ?>
      <div id="cuatro-inferiores" class="region <?php print ns('grid-3', $page['tryptic_first']); ?> omega">
        <?php print render($page['cuatro_inferiores']);?>
      </div>
    <?php endif; ?>
  </div>
...
<!-- /inferiores -->
  ...
  <div id="footer-wrapper" class="grid-12 clearfix">
    ...
    <?php endif; ?>
    <div id="footer" class="region <?php print ns('grid-12'); ?> omega">
      <?php if ($page['footer']): ?>
