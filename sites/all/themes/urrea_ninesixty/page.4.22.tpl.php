...
<div id="page" class="container-12 clearfix">
  ...
  <div id="site-header" class="grid-12 clearfix">
    <div id="branding" class="grid-4 alpha clearfix">
  ...
  <?php if ($is_front): ?>
    <?php if ($page['slide_show']): ?>
      <div id="slide-show" class="grid-12 clearfix">
  ...
  <div id="footer-wrapper" class="grid-12 clearfix">
    <?php if ($main_menu_links || $secondary_menu_links): ?>
      <div id="site-menu" class="region <?php print ns('grid-9', $page['sidebar_second'], 1); ?> alpha">
