...
/**
 * The default group for urrea_ninesixty framework CSS files added to the page.
 */
 ...
 */
function urrea_ninesixty_preprocess_html(&$vars) {
 ...
 */
function urrea_ninesixty_preprocess_page(&$vars, $hook) {
 ...
 * release of urrea_ninesixty warts and all. Future versions will make this obsolete.
 */
function urrea_ninesixty_css_alter(&$css) {
